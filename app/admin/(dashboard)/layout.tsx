...
export default function DashboardLayout({
  ...
  const NavItem = ({ href, icon: Icon, label, target }: {
    href: string;
        ...
        <div className="flex min-h-screen bg-orange-50 dark:bg-neutral-900">
          ...
          >
            ...
            <nav className="flex-1 overflow-y-auto p-4 space-y-1">
              ...
              <NavItem href="/" target="_blank" icon={Home} label="View Site" />
            </nav>
          ...
          <div className={cn("flex flex-col flex-1 min-h-screen", collapsed ? "md:ml-16" : "md:ml-64")}>
            <header
              className="h-16 border-b dark:border-neutral-800 flex items-center justify-between px-4 bg-white dark:bg-neutral-800 sticky top-0 z-10">
              ...
              <UserAvatar username="Vusal Alakbarov" />
            </header>
